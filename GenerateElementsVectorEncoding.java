...
public class GenerateElementsVectorEncoding {
   ...
   private Map<String, String> ReadDietzPreOrderXML(String FileName){
    ...
    public List<NameSpaceVectorEncodeBean> getNameSpaces(int DocID, String FileName){
       ...
       for(int tt=0; tt<additionalnamespace.size();tt++){
           ...
           xmlnamespacebean.add(new NameSpaceVectorEncodeBean(DocID, additionalnamespace.get(tt).getPrefix(),additionalnamespace.get(tt).getURI(),0));
       }
  ...
  public void GenerateElementsVectorEncodings(int DocID, String FileName){
    ...
    /*public static void main(String args[]){
       ...
       ArrayList<ElementVectorDietzEncodingBean> elementlist = encode.getElementBean(0, "streamnetworks.xml");
       List<NameSpaceVectorEncodeBean> namespacelist = encode.getNameSpaces(0,"streamnetworks.xml");
