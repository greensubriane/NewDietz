...
public class GenerateTextVectorEncoding {
   private  ArrayList<TextPreVectorDietzEncodingBean> textlists = new ArrayList<TextPreVectorDietzEncodingBean>(); 
   ...
   public ArrayList<TextVectorDietzEncodingBean> getTextBean(int DocID, String FileName){       
    ...
    public void GetTextName(int DocumentID, Element root){          
     ...
     /*public static void main(String args[]){
        ...
        ArrayList<TextVectorDietzEncodingBean> textvectordietzencodebeans = textencode.getTextBean(0, "boudaries.xml");         
